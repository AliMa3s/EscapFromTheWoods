...
namespace ExportToFile {
   public static class Export {
        ...
        public static async Task ExportToBitMap(List<Monkey> monkeysInTheSameWood) {
            ...
            Console.WriteLine($"Start writing to png-file wood {wood.Id}");
            ...
            bm.Save(Path.Combine(Config.Path, wood.Id.ToString() + "_escapeRoutes.png"), ImageFormat.Png);
